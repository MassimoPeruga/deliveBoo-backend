...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('admin.restaurants.update', $restaurant->id) }}" method="POST" enctype="multipart/form-data">
            ...
            @method('PUT')
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label" name="name" value="{{ $restaurant->name }}">name:</label>
            ...
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label" name="vat"value="{{ $restaurant->vat }}">vat:</label>
